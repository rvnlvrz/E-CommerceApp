                ...
                <div class="container">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <asp:CompareValidator ID="CompareEndTodayValidator" Operator="GreaterThan" Type="Date" ControlToValidate="card_expiryTextBox" ErrorMessage="The card you will use should not be expired." runat="server" Display="Dynamic" ForeColor="#FF5050" OnPreRender="CompareEndTodayValidator_PreRender" />
                        </div>
                        <div class="form-group col-sm-4">
